			...
			<div class="row">
				...
				<div class="col-md-12" style="margin-bottom:1%;">
                    <div class="btn-group " role="group" data-toggle="tooltip" data-placement="top" title="" data-original-title="" aria-describedby="">
                        <a href="<?php echo base_url();?>Sales_report/generate_report_customer_csv" class="btn btn-primary btn-mini  waves-effect waves-light" style="color:white;">Download in CSV</a>
                        <a href="<?php echo base_url();?>Sales_report/generate_report_customer_excel" class="btn btn-primary btn-mini waves-effect waves-light" style="color:white;">Download in Excel</a>
                    </div>
                </div>
					...
					<div class="card" id="slide_show">
						...
						<div class="card-block">
									...
									<div class="col-md-3 col-sm-12">
										...
										?>
														<a id="filter_by_store" data-store_id="<?php echo $store_id;?>" class="dropdown-item waves-light waves-effect"
															href="<?php echo base_url();?>Manager/filter_customer/store/<?php echo $store_id;?>">
													...
													?>
														<a id="filter_by_store" data-store_id="<?php echo $store_id;?>" class="dropdown-item waves-light waves-effect"
															href="<?php echo base_url();?>Store_Owner/filter_customer/store/<?php echo $store_id;?>">
															<?php echo $store_name;?></a>
													<?php
													}
									...
									<div class="col-md-4 col-sm-12">
										...
										?>
														<a id="filter_by_branch" data-branch_id="<?php echo $branch_id;?>" class="dropdown-item waves-light waves-effect"
															href="<?php echo base_url();?>Manager/filter_customer/branch/<?php echo $branch_id;?>"><?php echo $get_store_name;?>
															(<?php echo $branch_name;?> Branch)</a>
													<?php
													}elseif($user_status =='store_owner'){?>
														<a id="filter_by_branch" data-branch_id="<?php echo $branch_id;?>" class="dropdown-item waves-light waves-effect"
															href="<?php echo base_url();?>Store_Owner/filter_customer/branch/<?php echo $branch_id;?>"><?php echo $get_store_name;?>
															(<?php echo $branch_name;?> Branch)</a>
													<?php
													}
												}
                            ...
                            <a data-toggle="modal" href="#large-Modal" class="btn btn-danger"
								style="margin-bottom:1%; float:left;"><i class="fa fa-plus"></i>Add Customer</a>

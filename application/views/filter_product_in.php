			...
			<div class="row">
				...
				<div class="col-md-12" style="margin-bottom:1%;">
                    <div class="btn-group " role="group" data-toggle="tooltip" data-placement="top" title="" data-original-title="" aria-describedby="">
                        <a href="<?php echo base_url();?>Sales_report/generate_report_product_in_params_stock_csv/<?php echo $type;?>/<?php echo $store_id;?>" class="btn btn-primary btn-mini  waves-effect waves-light" style="color:white;">Download in CSV</a>
                        <a href="<?php echo base_url();?>Sales_report/generate_report_product_in_params_stock_excel/<?php echo $type;?>/<?php echo $store_id;?>" class="btn btn-primary btn-mini waves-effect waves-light" style="color:white;">Download in Excel</a>
                    </div>
                </div>
				...
				<div class="col-md-12" id="slideshow">
					<div class="card" id="slide_show">
						<div class="card-header">
							<h5>List All Product In-Stock</h5>
									...
									<div class="col-md-3 col-sm-12">
										...
										?>
														<a id="filter_by_store" data-store_id="<?php echo $store_id;?>" class="dropdown-item waves-light waves-effect"
															href="<?php echo base_url();?>Manager/filter_product_in/store/<?php echo $store_id;?>">
															<?php echo $store_name;?></a>
													<?php 
													}elseif($user_status =='store_owner'){?>
														<a id="filter_by_store" data-store_id="<?php echo $store_id;?>" class="dropdown-item waves-light waves-effect"
															href="<?php echo base_url();?>Store_Owner/filter_product_in/store/<?php echo $store_id;?>">
															<?php echo $store_name;?></a>
													<?php
													}
												}
									...
									<div class="col-md-4 col-sm-12">
										...
										?>
														<a id="filter_by_branch" data-branch_id="<?php echo $branch_id;?>" class="dropdown-item waves-light waves-effect"
															href="<?php echo base_url();?>Manager/filter_product_in/branch/<?php echo $branch_id;?>"><?php echo $get_store_name;?>
															(<?php echo $branch_name;?> Branch)</a>

													<?php 
													}elseif($user_status =='store_owner'){?>
														<a id="filter_by_branch" data-branch_id="<?php echo $branch_id;?>" class="dropdown-item waves-light waves-effect"
															href="<?php echo base_url();?>Store_Owner/filter_product_in/branch/<?php echo $branch_id;?>"><?php echo $get_store_name;?>
															(<?php echo $branch_name;?> Branch)</a>
													<?php
													}
												}
...
<script>
	...
	$(function() {
		...
		function ajaxlist(page_url = false)
		{
			...
			var base_url = '<?php echo site_url('Office/filter_product_in_ajax/') ?>';

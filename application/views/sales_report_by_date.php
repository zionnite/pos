					...
					<div class="card" id="slide_show">
						<div class="card-header">
							...
							($type =='default') ? 
								...
								:
								$title			='Transaction Filter By Date';
							?>
						...
						<div class="card-block">
							...
							<div class="my_filter" style="margin-bottom:1%; float:eright;">


								<div class="row">
									<div class="col-md-6" style="margin-left:-1%;">
										<div class="col-md-12">
											<form action="<?php echo base_url();?>Sales_report/dt" method="post">
												<div class="row">
													<div class="col-md-4">
														<h6>Start Date</h6>
													...
													<div class="col-md-4">
														<h6>&nbsp;</h6>
														<input type="submit" name="submit" class="form-control btn btn-success btn-sm" name="submit"
															value="Submit">
													</div>
												</div>
											</form>
									...
									<div class="col-md-6" style="margin-top:1.78%;">
										<div class="col-md-12">
											<div class="row">
												<div class="<?php if($user_status =='sales_rep'){ echo 'col-md-12 col-sm-12'; }else{ echo 'col-md-5 col-sm-12';}?>">
